...
//                             ),
//                           ),
//                           onPressed: () => sortingBar(context, userProvider.isOlder, userProvider.sortUsers),
...
//                     }
//                     Map<String, dynamic> user = userProvider.foundUsers[index];
//                     return Card(
//                       color: Colors.white,
//                       child: ListTile(
              ...
              child: NotificationListener<ScrollNotification>(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Map<String, dynamic>? userData = userProvider.foundUsers[index];
                    if (userData != null) {
