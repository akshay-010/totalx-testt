...
class _UserListsState extends State<UserLists> {
  ...
  Future<void> _fetchUsers() async {
    ...
    setState(() {
      // foundUsers = snapshot.docs.map((doc) => doc.data()).toList();
      foundUsers = snapshot.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
  ...
  void _runFilter(String enteredKeyword) {
    ...
    setState(() {
      foundUsers = foundUsers.where((user) =>
